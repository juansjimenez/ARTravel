                        ...
                        if($stmt_1->execute()){
                            if($stmt_1->rowCount() >= 1){
                                ...
                                if($stmt = $db_par->prepare($sql)){
                                    ...
                                    if($stmt->execute()){
                                        $data = $stmt -> fetchall();
                                        echo "<p style=font-size:25px>Categoría: Museo</p>";
                                        echo "<p style=font-size:25px>Precio entrada: \${$data_museos[0][0]}</p>";
                                        echo "<p style=font-size:25px>Hora apertura: {$data_museos[0][1]}</p>";
                                        echo "<p style=font-size:25px>Hora cierre: {$data_museos[0][2]}</p>";
                                        echo "<p style=font-size:25px>Ciudad: {$data[0][1]}</p>";
                                        echo "<p style=font-size:25px>País: {$data[0][2]}</p>";
                                        echo "<p style=font-size:25px>Número contacto: {$data[0][3]}</p>";
                        ...
                        if($stmt_1->execute()){
                            if($stmt_1->rowCount() >= 1){
                                ...
                                if($stmt = $db_par->prepare($sql)){
                                    ...
                                    if($stmt->execute()){
                                        $data = $stmt -> fetchall();
                                        echo "<p style=font-size:25px><strong>Categoría:</strong> Iglesia</p>";
                                        echo "<p style=font-size:25px><strong>Hora apertura:</strong> {$data_iglesias[0][0]}</p>";
                                        echo "<p style=font-size:25px><strong>Hora cierre: </strong>{$data_iglesias[0][1]}</p>";
                        ...
                        if($stmt_1->execute()){
                            if($stmt_1->rowCount() >= 1){
                                ...
                                if($stmt = $db_par->prepare($sql)){
                                    ...
                                    if($stmt->execute()){
                                        $data = $stmt -> fetchall();
                                        echo "<p style=font-size:25px><strong>Categoría:</strong> Plaza</p>";
                                        echo "<p style=font-size:25px><strong>Ciudad: </strong>{$data[0][1]}</p>";
                                        echo "<p style=font-size:25px><strong>País:</strong> {$data[0][2]}</p>";
                                        echo "<p style=font-size:25px><strong>Número contacto: </strong>{$data[0][3]}</p>";
                ...
                <?php
                    ...
                    if($stmt = $db_par->prepare($sql)){
                        ...
                        if($stmt->execute()){
                            ...
                            foreach ($data as $p) {
                                echo "<tr style=font-size:25px><td><a href='info_artistas.php?id=$p[0]'>$p[1]</a></td></tr>";
                            }
                            echo "</table>";
                    ...
                    if($stmt = $db_par->prepare($sql)){
                        ...
                        if($stmt->execute()){
                            ...
                            echo "<table class='container'>\n";
                              ...
                              echo "</tr>";
                            foreach ($data as $p) {
                                echo "<tr style=font-size:25px><td><a href='info_obras.php?id=$p[0]'>$p[1]</a></td><td>$p[2]</td><td style=font-size:25px>$p[3]</td></tr>";
                            }
                            echo "</table>";
