  ...
  <section>
    <div class="container">
            <div class="p-5" data-aos="fade-right" data-aos-delay="100">
                <div class="masthead-content">
                    <h1 style=font-size:45px>Enviados</h1>
                    <?php
                    function mensajes_enviados($id)
                    {
                        ...
                        if( isset($array["user_messages"])){
                            ...
                            $enviados = json_encode($enviados, JSON_PRETTY_PRINT);
                            return $enviados;
                        } else {
                            return "<p style=font-size:25px>No has enviado ningún mensaje.</p>";
                        }
                    }

                    $id = $_SESSION["id"];
                    $recived =  json_decode(mensajes_enviados($id));
