                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="p-5" data-aos="fade-right" data-aos-delay="100">
                            ...
                            <form action="enviar_mensaje.php" method="get" class="form-group">
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Username:</label>
                                    <input type="text" class="form-control" id="username_receptor" name="username_receptor" placeholder="Escriba el username">
                                </div>
