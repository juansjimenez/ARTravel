...
<body>
  ...
  <header class="masthead text-center text-white">
    <div class="masthead-content">
        <div id="leftbox">
            <h1 style=font-size:100px>Lugares</h1>
        </div>
    </div>
  </header>
        ...
        <div >
            <div class="p-5" data-aos="fade-right" data-aos-delay="100">
                <?php
                    ...
                    $sql = "SELECT lid, nombre FROM lugares";
                    ...
                    if($stmt = $db_par->prepare($sql)){
                        ...
                        if($stmt->execute()){
                            ...
                            foreach ($data as $p) {
                                ...
                                if ($m) {
                                    echo "<tr h1 style=font-size:25px><td><a href='info_museos.php?id=$p[0]'>$p[1]</a></td></tr>";
                                } else {
                                    echo "<tr h1 style=font-size:25px><td><a href='info_lugares.php?id=$p[0]'>$p[1]</a></td></tr>";
                                }
                            }
                            echo "</table>";
                        } else{
